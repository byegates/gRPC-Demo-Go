...
type SqrtRequest struct {
	...
	X int32 `protobuf:"varint,1,opt,name=x,proto3" json:"x,omitempty"` // uint32 is probably better, but this is to test error handling, so we take negatives
}
...
func (x *SqrtResponse) GetVal() float64 {
	if x != nil {
		return x.Val
	}
	return 0
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x1b, 0x0a, 0x0b, 0x53, 0x71, 0x72, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x01, 0x78, 0x22, 0x20, 0x0a, 0x0c, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x76, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x03, 0x76, 0x61, 0x6c, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x79, 0x65, 0x67, 0x61, 0x74, 0x65, 0x73, 0x2f, 0x67,
	0x52, 0x50, 0x43, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
